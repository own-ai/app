        ...
        <div className="bg-surface border border-border rounded-lg shadow-lg max-w-md w-full p-6 animate-slide-down">
            ...
            {needsApiKey && !hasApiKey && (
              <div className="flex items-start gap-3 p-3 rounded-md bg-amber-50 border border-amber-200 text-amber-800">
                ...
                <div className="flex-1 text-sm">
                  <p className="font-medium">{t('ai_instances.api_key_missing')}</p>
                  <p className="text-amber-700 mt-0.5">{t('ai_instances.api_key_missing_hint')}</p>
                  {onOpenSettings && (
                    <button
              ...
              {suggestedModels.length > 0 ? (
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="custom">{t('ai_instances.model_custom')}</option>
                  </select>
                  {model === 'custom' && (
                    <Input
                      value=""
          ...
          <div className="flex items-center justify-end gap-3 mt-6">
            ...
            <Button
              ...
              disabled={!name.trim() || !model.trim() || (needsApiKey && !hasApiKey) || isCreating}
            >
